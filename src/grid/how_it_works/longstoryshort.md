...
Well, we'd recommend heading back to the [intro page](src.md) and taking another read.
...
Good news! We've actually written up a nice explanation about [why a token is needed](token_why.md). And if you're new to the world of digital currencies, you can read more [here](newtotokens.md).
